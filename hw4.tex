...
&\leq  \frac{n}{\left (0.8n -  \frac{(n-1)^n}{n^{n-1}} \right )^2}\\
&= \frac{nn^{2n-2}}{\left (0.8 n n ^{n-1} -(n-1)^n \right )^2}\\
&= \frac{n^{2n-1}}{\left (0.8 n ^n -(n-1)^n \right )^2}\\
&= \frac{n^{2n-1}}{0.64n^{2n} -1.6n^n(n-1)^n +(n-1)^{2n}}\\
\end{aligned}
\end{equation*}
